...
\begin{frame}
	...
	\begin{itemize} 
		...
		\item Entender el impacto en la confiabilidad de las redes solución, al aumentar o disminuir las confiabilidades elementales tanto en nodos como enlaces. %probabilidades de falla
...
\begin{block} {}
	...
	\item \emph{Se introduce The Generalized Steiner Problem with Node-Connectivity Constraints and Hostile Reliability (GSPNCHR)}.
	\item \emph{Probamos formalmente que GSPNCHR pertenece a la clase NP-Hard}.
	\item \emph{Como consecuencia se propone una metodología GRASP/VND}.
	\end{scriptsize}   	     	
 	\end{itemize} 	
 \end{block}
\end{frame}
...
\begin{block} {}
	...
	\item \emph{Nuestros resultados resaltan que el modelo es más robusto bajo fallas en los nodos que bajo fallas en los enlaces}.
	\item \emph{Se logró la publicación: A GRASP/VND Heuristic for the Generalized Steiner Problem with Node-Connectivity Constraints and Hostile Reliability, a publicarse en Volume 12559 of the Lecture Notes in Computer Science series}.
	\end{scriptsize}   	     	
 	\end{itemize} 	
 \end{block}
\end{frame}
